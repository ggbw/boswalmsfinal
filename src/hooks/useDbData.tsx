    ...
    try {
      ...
      const dbData: DB = {
        ...
        marks: (marksRes.data || []).map((m: any) => ({
          ...
          classId: m.class_id,
          test1: Number(m.test1),
          test2: Number(m.test2),
          practTest: Number(m.pract_test),
          indAss: Number(m.ind_ass),
          grpAss: Number(m.grp_ass),
          finalExam: Number(m.final_exam),
          practical: Number(m.practical),
          year: m.year,
          semester: m.semester,
        })),
        ...
        submissions: (submissionsRes.data || []).map((s: any) => ({
          ...
          submittedTime: s.submitted_time || "",
