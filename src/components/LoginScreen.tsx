    ...
    <div className="login-bg">
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: "linear-gradient(160deg,rgba(11,31,74,0.88) 0%,rgba(5,12,30,0.72) 45%,rgba(11,31,74,0.88) 100%)",
          pointerEvents: "none",
        }}
      />
      <div
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        <div className="login-card">
          ...
          <div style={{ marginTop: 14, textAlign: "center" }}>
            <div style={{ fontSize: 11, color: "#666", marginBottom: 8 }}>Not a student yet?</div>
            <a
              href="/apply"
              style={{
                display: "block",
